...
public class ItemAdapterUpComing extends RecyclerView.Adapter<ItemAdapterUpComing.ItemViewHolder> {

  List<ItemProductUpComing> list;
  private Context context;

  public ItemAdapterUpComing(List<ItemProductUpComing> list) {
    this.list = list;
  }
  ...
  public void onBindViewHolder(@NonNull ItemViewHolder holder, int position) {
    ...
    final ItemProductUpComing itemProductTopRated = list.get(position);
