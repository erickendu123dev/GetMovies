...
public class ItemAdapterTopRated extends RecyclerView.Adapter<ItemAdapterTopRated.ItemViewHolder> {

  List<ItemProductTopRated> list;
  private Context context;

  public ItemAdapterTopRated(List<ItemProductTopRated> list) {
    this.list = list;
  }
  ...
  public void onBindViewHolder(@NonNull ItemViewHolder holder, int position) {
    ...
    final ItemProductTopRated itemProductTopRated = list.get(position);
