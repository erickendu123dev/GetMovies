...
public class ItemAdapterPopular extends RecyclerView.Adapter<ItemAdapterPopular.ItemViewHolder> {

  List<ItemProductPopular> list;
  private Context context;

  public ItemAdapterPopular(List<ItemProductPopular> list) {
    this.list = list;
  }
  ...
  public void onBindViewHolder(@NonNull ItemViewHolder holder, int position) {
    ...
    final ItemProductPopular itemProductTopRated = list.get(position);
